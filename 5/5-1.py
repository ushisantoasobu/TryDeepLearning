...
# backward
d_price = 1
dall_price, dtax = mul_tax_layer.backward(d_price)
dapple_price, dorange_price = mul_apple_orange_layer.backward(dall_price)
dapple, dapple_num = mul_apple_layer.backward(dapple_price)
dorrange, dorrange_num = mul_orange_layer.backward(dorange_price)

print(dapple, dapple_num, dorrange, dorrange_num, dtax)
